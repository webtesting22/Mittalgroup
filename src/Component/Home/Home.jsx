    ...
    <>
      <div className="AnimatedHomeSlider">
        <div className="MSLHomeContent">
          ...
          <p>
            MSL provides premium steel products designed for strength and
            durability. Our precision engineering ensures reliable solutions for
            every project.
          </p>
        </div>
            ...
            <SwiperSlide>
              <video
                ...
                style={{
                  ...
                  pointerEvents: "none",
                  objectFit: "cover",
                }} // Ensure no interaction triggers fullscreen
              />
            </SwiperSlide>
          </Swiper>
        </div>
