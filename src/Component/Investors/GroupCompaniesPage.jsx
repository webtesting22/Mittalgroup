...
const Investors = () => {
  ...
  const [selectedCompany, setSelectedCompany] = useState("Abhyaryan");
  ...
  const currentDocuments = DocumentData["Group Companies"][selectedCompany];

  // Get list of all companies in Group Companies
  const groupCompanies = Object.keys(DocumentData["Group Companies"]);
