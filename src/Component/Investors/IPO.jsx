...
const IPO = () => {
  ...
  const [selectedCompany, setSelectedCompany] = useState("RHP");
          ...
          <Row>
            <Col lg={6} sm={24} xs={24}>
              <div className="companyList">
                <ul>
                  {/* Render list of IPO sections dynamically */}
                  {groupCompanies.map((company) => (
                    <li
                      ...
                      style={{
                        fontWeight:
                          selectedCompany === company ? "bold" : "normal",
                        backgroundColor:
                          selectedCompany === company ? "white" : "whitesmoke",
                      }}
                    >
                      {company}
                    </li>
