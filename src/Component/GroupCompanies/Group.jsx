      ...
      <section className='sectionPadding'>
        <div id='CardContainer'>
          <Row>
            <Col lg={6} md={24} data-aos="fade-up">
              <div>
                <h2 >MITTAL SECTIONS LIMITED</h2>
                <img src={MittalSectionsLogo} alt="" />
              </div>
            </Col>
        ...
        <div id='CardContainer'>
          <Row>
            <Col lg={6} md={24} data-aos="fade-up">
              <div >
                <h2>MITTAL STEEL, AM STEEL & AROO INDUSTRIES</h2>
                <img src={MittalSteelLogo} alt="" />
            ...
            <Col lg={18} md={24} data-aos="fade-up">
              <div className='RightSideContainerContent'>
                <p><b>Mittal Steel,</b> AM Steel and Aroo Industries are the proud members of AB Mittal group of companies which were established in 2011. Mittal Steel and AM Steel are industrial induction furnace manufacturing companies, and Aroo Industries is in the production of MS and alloy steel ingots. Previously, Mittal Steel and AM Steel were commissioned together in 2011. Later Aroo industries came into the picture in 2015.</p>
                <br />
