            ...
            <section style={{ backgroundColor: "black", position: "sticky" }}>
                {/* <div className="FooterContainer">
                    <div>
                        ...
                        <p className="footerPara"><i class='bx bxs-phone'   ></i><b>Phone:     </b> <a href="tel:9909905484">  9909905484</a> <i class='bx bx-envelope'  ></i><b>Email: </b><a href="mailto:mittalsection@gmail.com">mittalsection@gmail.com</a></p>                    </div>
